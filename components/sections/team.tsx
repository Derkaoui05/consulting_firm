    ...
    <section id="team" className="bg-muted/30 py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mt-16 grid gap-8 grid-cols-2 lg:grid-cols-4"
        >
          {team.map((member) => (
            <motion.div
              key={member.name}
            ...
            >
              {/* Square Avatar with clip reveal */}
              <motion.div
              ...
              <motion.p
                variants={fadeUp}
                className="mt-3 text-xs sm:text-sm text-muted-foreground leading-relaxed"
              >
                {member.bio}
              </motion.p>
            </motion.div>
